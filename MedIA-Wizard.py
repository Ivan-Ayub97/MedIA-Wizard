...
from customtkinter import (CTk, CTkButton, CTkEntry, CTkFont, CTkImage,
                           ...
                           CTkToplevel, filedialog, set_appearance_mode,
...
app_name = "MedIA-Wizard"
version  = "1.0"

app_name_color          = "#FFFF00"  # Título blanco
dark_color     = "#000000"
...
class MessageBox(CTkToplevel):
    ...
    def placeInfoMessageTitleSubtitle(
        ...
        if self._messageType == "info":
            title_subtitle_text_color = "#FFFF00"
        elif self._messageType == "error":
            title_subtitle_text_color = "#020202"
...
def user_input_checks() -> bool:
    ...
    if tiles_resolution > 0:
        if selected_AI_model in RealESRGAN_models_list:
